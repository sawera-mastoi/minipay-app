  ...
  return (
    <div className='text-center py-8'>
      <motion.div 
        ...
        className='text-7xl font-black text-transparent bg-clip-text bg-gradient-to-br from-yellow-300 to-orange-500'
      >
        {count}
      </motion.div>
      ...
      <div className='mt-4'>
        <ShareButton text={`I've built a ${count} day streak on MiniPay! Join me on Celo.`} />
      </div>
    </div>
  );
};
